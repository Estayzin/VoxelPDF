...
- orientacion_norte: PRIMERO — clasifica el tipo de lámina: si es corte, elevación, alzado, fachada, detalle, perspectiva, cuadro o tabla → marca presente=true con "No aplica — lámina tipo [X]". Para PLANTAS de cualquier especialidad (ARQ, MEP, instalaciones, estructura, coordinación): recorre TODA la hoja incluyendo viñeta, esquinas y márgenes buscando MUY ACTIVAMENTE cualquiera de estos tres elementos — (a) SÍMBOLO DE NORTE o DE ORIENTACIÓN: aplica una definición MUY amplia — cuenta cualquiera de estas formas: flecha de norte, rosa de los vientos, símbolo con letra "N"/"NORTE"/"NORTH", Y TAMBIÉN cualquier brújula o compás (círculo con una aguja, línea gruesa, triángulo o marcador interior que apunta en una dirección), y cualquier dial o indicador circular de orientación aunque no tenga letra N visible — si ves un círculo con una línea, aguja o elemento interior que indica una dirección, trátalo como símbolo de norte válido; puede estar en cualquier esquina, dentro de la viñeta, o integrado junto al plano llave. (b) PLANO DE UBICACIÓN o EMPLAZAMIENTO: diagrama pequeño que muestra el terreno, manzana o edificio en su entorno urbano, generalmente con una flecha norte. (c) PLANO LLAVE o KEY PLAN: cualquier diagrama o recuadro pequeño que muestre la silueta o esquema simplificado de la planta o del edificio, con o sin zona resaltada; su sola presencia en cualquier parte de la lámina (viñeta, esquinas, márgenes) ya es suficiente — marca presente=true aunque no tenga flecha norte explícita. Si encuentras CUALQUIERA de los tres elementos, marca presente=true describiendo cuál encontraste y dónde está. Ante la duda, marca true. Marca false ÚNICAMENTE si revisaste absolutamente toda la lámina y no hay ningún símbolo de orientación, ningún dial/brújula, ningún plano llave ni diagrama de referencia.
- nombres_ambientes: Si la lámina es corte, elevación, alzado, fachada, detalle, perspectiva, cuadro o tabla → marca presente=true con "No aplica — lámina tipo [X]". Para plantas, evalúa según el tipo: (A) Plantas de ARQ, MEP, instalaciones o estructura → busca etiquetas de recintos en el área de dibujo: CÓDIGOS X.X.X, nombres completos (DORMITORIO, BAÑO, COCINA, SALA, LIVING, SALA DE MÁQUINAS, LABORATORIO, etc.), abreviaciones (DORM., HAB., BÑO., SS.HH, WC) y regionalismos (PIEZA, CUARTO, QUINCHO) — los planos MEP y estructura suelen mostrar las etiquetas arquitectónicas de base, búscalas. Si el texto es pequeño, claro o de baja opacidad pero percibes que hay etiquetas de recintos, marca presente=true. Ante la duda, marca true. (B) Plantas de coordinación (varios sistemas superpuestos o láminas con código ALL, COORD o similar) → evalúa si se identifica claramente el edificio, bloque, torre o sector al que corresponde el dibujo (ej: "Edificio A", "Block B", "Torre 1", "Sector Norte", nombre del recinto principal) — esto es necesario para evitar ambigüedad sobre qué edificio se está viendo. Marca false ÚNICAMENTE si revisaste toda la lámina y no hay absolutamente ninguna etiqueta de recinto en el tipo A, o no se identifica el edificio/sector en el tipo B.
