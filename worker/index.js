...
- orientacion_norte: PRIMERO — clasifica el tipo de lámina: si es corte, elevación, alzado, fachada, detalle, perspectiva, cuadro o tabla → marca presente=true con "No aplica — lámina tipo [X]". Para PLANTAS de cualquier especialidad (ARQ, MEP, instalaciones, estructura, coordinación): recorre TODA la hoja incluyendo viñeta, esquinas y márgenes buscando MUY ACTIVAMENTE cualquiera de estos tres elementos — (a) SÍMBOLO DE NORTE: cualquier flecha, círculo con flecha, rosa de los vientos o símbolo que contenga la letra "N", la palabra "NORTE" o "NORTH", sin importar su tamaño ni si tiene o no círculo decorativo; puede estar en cualquier esquina, dentro de la viñeta, o integrado dentro o junto al plano llave — si ves una flecha o letra N asociada al key plan, cuenta como símbolo de norte válido. (b) PLANO DE UBICACIÓN o EMPLAZAMIENTO: diagrama pequeño que muestra el terreno, manzana o edificio en su entorno urbano, generalmente con una flecha norte. (c) PLANO LLAVE o KEY PLAN: diagrama pequeño que muestra la planta completa del piso o edificio con un área sombreada, enmarcada o resaltada que indica qué sector cubre esta lámina; suele estar en la viñeta o en una esquina — su sola presencia ya es un indicador de referencia válido aunque no tenga flecha norte explícita. Si encuentras CUALQUIERA de los tres, marca presente=true describiendo cuál encontraste. Ante la duda, marca true. Marca false ÚNICAMENTE si revisaste cada centímetro de la lámina y no hay absolutamente ningún indicador de orientación ni diagrama de referencia.
