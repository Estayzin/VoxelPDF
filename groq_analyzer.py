...
- orientacion_norte: PRIMERO: si la lámina es corte, elevación, alzado, fachada, detalle, perspectiva, cuadro o tabla → marca presente=true con "No aplica — lámina tipo [X]". Para plantas de cualquier especialidad (arquitectura, instalaciones, estructura, MEP): busca CUALQUIERA de estas indicaciones de norte — (a) símbolo de norte, flecha N, flecha con la letra N o la palabra NORTE, aunque sea una flecha simple sin círculo; (b) plano de ubicación, plano de emplazamiento o diagrama de zona que muestre la posición del área dentro del proyecto — puede estar en la viñeta, en una esquina del dibujo o en cualquier parte de la lámina. Marca false SOLO si no encuentras absolutamente ninguno de los dos en toda la lámina.
- nombres_ambientes: Si la lámina es corte, elevación, alzado, fachada, detalle, perspectiva, cuadro o tabla → marca presente=true con "No aplica — lámina tipo [X]". Para plantas de CUALQUIER especialidad (arquitectura, instalaciones, estructura, etc.) evalúa si hay etiquetas de recintos o espacios: CÓDIGOS X.X.X, nombres completos (DORMITORIO, BAÑO, COCINA, SALA, LIVING, SALA DE MÁQUINAS, CUARTO DE BOMBAS, LABORATORIO, etc.), abreviaciones (DORM., HAB., BÑO., SS.HH, WC) y regionalismos (PIEZA, CUARTO, QUINCHO). Los planos de instalaciones suelen mostrar las etiquetas arquitectónicas de base — búscalas.
