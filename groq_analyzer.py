...
- nombres_ambientes: PRIMERO determina el tipo de lámina. Marca presente=true con "No aplica — [categoría]" en estos casos: (a) láminas de corte, elevación, alzado, fachada, detalle, perspectiva, cuadro o tabla; (b) planos MEP/instalaciones: climatización, ductos, HVAC, eléctrica, iluminación, sanitaria, agua potable, incendio, gas, telecomunicaciones. Solo en plantas arquitectónicas puras evalúa: CÓDIGOS X.X.X, nombres completos (DORMITORIO, BAÑO, COCINA, SALA, LIVING, etc.), abreviaciones (DORM., HAB., BÑO., SS.HH, WC) y regionalismos (PIEZA, CUARTO, QUINCHO).
